...
class MakePhiData extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        ...
        $socialMenuItems = [
            [
                ...
                'uri' => 'https://www.facebook.com/nguyen.ha.phu.phi/',
                'type' => 'link',
                'menu_type_id' => '2',
            ],
        ];
