...
@section('content')
    <div class="row">
                                ...
                                <td class="no-padding" style="vertical-align: middle">
                                    <div class="dropdown">
                                        ...
                                        <ul class="dropdown-menu dropdown-menu-right" role="menu">
                                            <li><a href="{{route('page-tags.edit',[$item->id])}}" title="Edit">Edit</a></li>
                                            <li><a href="javascript:void(0);" class="grid-row-delete" data-url="{{route('page-tags.destroy',[$item->id])}}" title="Delete" data-parent-elm="tr">Delete</a></li>
                                        </ul>
                                    </div>
                                </td>
                            </tr>
        ...
        <div class="col-md-4 pl-0 pull-right">
            <div class="box box-primary">
                <div class="box-header with-border">
                    <h3 class="box-title">Add new tag</h3>
                </div>
                <form action="{{route('page-tags.store')}}" method="post" accept-charset="UTF-8"
                      enctype="multipart/form-data" pjax-container="">
                    {{ csrf_field() }}
                    <div class="box-body table-responsive">
                        <div class="form-group  ">
                            <label for="tag_name" class="control-label">Name Tag &nbsp;<span style="color:#db4437;">*</span></label>
                        ...
                        <div class="form-group  ">
                            <label for="slug" class="control-label">Slug &nbsp;<span style="color:#db4437;">*</span></label>
