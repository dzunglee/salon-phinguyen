...
class translateController extends Controller
{
    ...
    public function getTranslate()
    {
        if (!empty(\request()->lang) && in_array(\request()->lang, $this->lang)) {
            if (\request()->lang == 'vi') {
                ...
                $jsonString = file_get_contents($this->langPath . 'en.json');
                $jsonStringVi = file_get_contents($this->langPath . 'vi.json');
    ...
    public function changeTranslate(Request $request)
    {
        ...
        if ($lang == 'vi') {
            ...
            file_put_contents($this->langPath . 'vi.json', $newJsonString);
            return back();
        } else {
            $jsonString = file_get_contents($this->langPath . 'en.json');
            $data = json_decode($jsonString, true);
            ...
            file_put_contents($this->langPath . 'en.json', $newJsonString);
            return back();
        }
